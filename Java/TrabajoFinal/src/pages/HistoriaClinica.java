...
public class HistoriaClinica extends JFrame {
    ...
    {
        this.add(new MyLabel("Dados Generales", 5, 5,fontsize));
        ...
        this.add(new MyLabel(" Motivo Consulta:",3, 290,fontsize));
        this.add(new MyLabel("Enfermedad Actual:",3, 330,fontsize));
        this.add(new MyLabel("Examen Fisico:",3, 370,fontsize));
